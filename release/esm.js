...
var CircleSeriesComponent = /** @class */ (function () {
    ...
    CircleSeriesComponent.prototype.onClick = function (value, label, extra) {
        this.select.emit({
            name: label,
            value: value,
            extra: extra
...
var HeatCellSeriesComponent = /** @class */ (function () {
    ...
    HeatCellSeriesComponent.prototype.onClick = function (value, label, series, extra) {
        this.select.emit({
            name: label,
            value: value,
            series: series,
    ...
    HeatCellSeriesComponent = __decorate([
        Component({
            ...
            template: "\n    <svg:g\n      ngx-charts-heat-map-cell\n      *ngFor=\"let c of cells; trackBy: trackBy\"\n      [x]=\"c.x\"\n      [y]=\"c.y\"\n      [width]=\"c.width\"\n      [height]=\"c.height\"\n      [fill]=\"c.fill\"\n      [data]=\"c.data\"\n      (select)=\"onClick($event, c.label, c.series, c.extra)\"\n      [gradient]=\"gradient\"\n      [animations]=\"animations\"\n      ngx-tooltip\n      [tooltipDisabled]=\"tooltipDisabled\"\n      [tooltipPlacement]=\"'top'\"\n      [tooltipType]=\"'tooltip'\"\n      [tooltipTitle]=\"tooltipTemplate ? undefined : tooltipText(c)\"\n      [tooltipTemplate]=\"tooltipTemplate\"\n      [tooltipContext]=\"{ series: c.series, name: c.label, value: c.data }\"\n    ></svg:g>\n  ",
            changeDetection: ChangeDetectionStrategy.OnPush
        })
...
var LineChartComponent = /** @class */ (function (_super) {
    ...
    function LineChartComponent() {
        ...
        _this.showGridLines = true;
        _this.curve = curveLinear;
        _this.overwriteActiveEntries = false;
        _this.trimXAxisTicks = true;
        _this.trimYAxisTicks = true;
        _this.rotateXAxisTicks = true;
        _this.maxXAxisTickLength = 16;
        ...
        _this.timelineHeight = 50;
        _this.timelinePadding = 10;
        _this._activeEntries = [];
        return _this;
    }
    Object.defineProperty(LineChartComponent.prototype, "activeEntries", {
    ...
    LineChartComponent.prototype.onClick = function (data, series, extra) {
        if (series) {
            data.series = series.name;
        }
        if (extra) {
    ...
    LineChartComponent.prototype.onActivate = function (item) {
        if (!this.overwriteActiveEntries) {
            this.deactivateAll();
            var idx = this._activeEntries.findIndex(function (d) {
                return d.name === item.name && d.value === item.value;
            });
            if (idx > -1) {
                return;
    ...
    LineChartComponent.prototype.onDeactivate = function (item) {
        if (!this.overwriteActiveEntries) {
            ...
            this._activeEntries = this._activeEntries.slice();
    ...
    LineChartComponent.prototype.deactivateAll = function () {
        if (!this.overwriteActiveEntries) {
            this._activeEntries = this._activeEntries.slice();
            for (var _i = 0, _a = this._activeEntries; _i < _a.length; _i++) {
                var entry = _a[_i];
                this.deactivate.emit({ value: entry, entries: [] });
            }
            this._activeEntries = [];
    ...
    __decorate([
        ...
        __metadata("design:type", Array),
        __metadata("design:paramtypes", [Array])
    ], LineChartComponent.prototype, "activeEntries", null);
    __decorate([
        Input(),
        __metadata("design:type", Boolean)
    ], LineChartComponent.prototype, "overwriteActiveEntries", void 0);
    __decorate([
        Input(),
        __metadata("design:type", String)
